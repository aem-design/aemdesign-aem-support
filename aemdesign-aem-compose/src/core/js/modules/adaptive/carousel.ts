...
import { CarouselType } from '@/core/types/enum'
import { breakpoints, margins } from '@/core/utilities/config'
import { getWindowWidth } from '@/core/utilities/dom'
 ...
 */
function loopAndGenerateCarousels(targets) {
