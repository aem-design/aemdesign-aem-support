 ...
 */
function removeCarouselFromTarget(target: CarouselElement): void {
 ...
 */
function refreshCarouselByTarget(target: CarouselElement): void {
  if (target.tinyslider) {
 ...
 */
function generateCarouselsFromTargets(
  targets: NodeListOf<CarouselElement>,
): void {
...
export default async (targets: NodeListOf<CarouselElement>): Promise<any> => {
  console.log(
