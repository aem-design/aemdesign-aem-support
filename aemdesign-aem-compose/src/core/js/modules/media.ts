...
import MediaInstance from '@/core/modules/media/instance'

import { MediaHandler, MediaProvider, MediaState } from '@/core/types/enum'

import { hasParent } from '@/core/utilities/dom'
...
export default async (mediaElements: NodeListOf<Element>) => {
  ...
  if (mediaBrands[MediaProvider.YOUTUBE].needed) {
    ...
    } = await import(/* webpackChunkName: "md/media/youtube" */ '@/core/modules/media/youtube')
